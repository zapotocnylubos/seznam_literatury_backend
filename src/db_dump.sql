...
-- Schema literature
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `literature` ;

-- -----------------------------------------------------
-- Schema literature
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `literature` DEFAULT CHARACTER SET utf8 COLLATE utf8_czech_ci ;
USE `literature` ;

-- -----------------------------------------------------
-- Table `literature`.`literature_sets`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`literature_sets` ;

CREATE TABLE IF NOT EXISTS `literature`.`literature_sets` (
...
-- -----------------------------------------------------
-- Table `literature`.`literature_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`literature_groups` ;

CREATE TABLE IF NOT EXISTS `literature`.`literature_groups` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_literature_groups_literature_sets1`
    ...
    REFERENCES `literature`.`literature_sets` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `literature`.`authors`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`authors` ;
...
-- -----------------------------------------------------
-- Table `literature`.`literature_forms`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`literature_forms` ;

CREATE TABLE IF NOT EXISTS `literature`.`literature_forms` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `literature`.`books`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`books` ;

CREATE TABLE IF NOT EXISTS `literature`.`books` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `fk_literature_set_items_authors`
    ...
    REFERENCES `literature`.`authors` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_literature_set_items_genres1`
    FOREIGN KEY (`literature_form_id`)
    REFERENCES `literature`.`literature_forms` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `literature`.`literature_sets_required_literature_forms`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`literature_sets_required_literature_forms` ;

CREATE TABLE IF NOT EXISTS `literature`.`literature_sets_required_literature_forms` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `literature`.`literature_groups_has_books`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `literature`.`literature_groups_has_books` ;

CREATE TABLE IF NOT EXISTS `literature`.`literature_groups_has_books` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_literature_groups_has_books_literature_groups1`
    ...
    REFERENCES `literature`.`literature_groups` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
